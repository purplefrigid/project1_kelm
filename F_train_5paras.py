...
if __name__ == '__main__':
    ...
    plt.plot(x_epochs, train_history['train_AvgLoss'], label='cnn_AvgLoss')
    ...
    plt.plot(x_epochs, train_history['train_AvgAccuracy'], label='cnn_AvgAccuracy')
    plt.legend(loc='best')
    plt.grid(False)
    plt.xlabel('Epoch')
